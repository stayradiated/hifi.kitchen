...
export const FETCH_PLAYLIST_ITEMS    = c('FETCH_PLAYLIST_ITEMS')
...
export const RESET_ALBUM_TRACKS   = 'RESET_ALBUM_TRACKS'
export const RESET_LIBRARY_ALBUMS = 'RESET_LIBRARY_ALBUMS'
...
export const RESET_LIBRARY_ARTISTS = 'RESET_LIBRARY_ARTISTS'
...
export const REMOVE_TRACK_FROM_PLAYLIST      = c('REMOVE_TRACK_FROM_PLAYLIST')
export const RESET_LIBRARY_PLAYLISTS         = 'RESET_LIBRARY_PLAYLISTS'
export const RESET_PLAYLIST_ITEMS            = 'RESET_PLAYLIST_ITEMS'

export const FETCH_LIBRARY_PLAYLISTS_REGULAR = c('FETCH_LIBRARY_PLAYLISTS_REGULAR')
export const RESET_LIBRARY_PLAYLISTS_REGULAR = 'RESET_LIBRARY_PLAYLISTS_REGULAR'
...
export const RESET_LIBRARY_TRACKS = 'RESET_LIBRARY_TRACKS'
